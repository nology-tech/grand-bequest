...
const Landing = () => {
  ...
  return (
    <main>
      ...
      <section className="welcome" style={{backgroundImage: `url(${wave})`}}>
      ...
      <section className="about">
        <h2 className="about__title">ABOUT</h2>
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam doloremque ipsam ut cum cupiditate amet, 
          temporibus perferendis corporis aut, aperiam quo. Nihil, aliquam sed vel recusandae eum qui voluptate molestias.
      ...
      <section className="contact">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam doloremque ipsam ut cum cupiditate amet, temporibus perferendis corporis aut,
           aperiam quo. Nihil, aliquam sed vel recusandae eum qui voluptate molestias.
           Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam doloremque ipsam ut cum cupiditate amet, 
          temporibus perferendis corporis aut, aperiam quo. Nihil, aliquam sed vel recusandae eum qui voluptate molestias</p>
